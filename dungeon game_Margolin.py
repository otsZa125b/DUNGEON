...
#SOUNDS
key = Sound("glassping.wav",1)#added sound for Key click
collision = Sound("collision.wav",2)#added sound for collisions
theme = Sound("zelda.wav",3)#added sound for theme
#TITLE SCREEN
game.over = False
hero.moveTo(500,150)
hero.resizeBy(+75)
...
while not game.over:
    ...
    if keypartscollected>=3:
        bk.draw()
        game.drawText("YOU WIN!!!!!!!!!" ,500,300,f)#increase the text size
